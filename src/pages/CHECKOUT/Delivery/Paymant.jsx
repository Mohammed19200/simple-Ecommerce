...
export default function Paymant() {
    ...
    function savedata() {
        ...
        axios.patch(`http://localhost:3004/users/${user.user.id}`, newData).then(data => { console.log(data.data)})
    }

    function handlecheckoutpayment(values, actions) {
        const newDatacheckoutpaymant = { paymentinfo: {...values} };
    
        axios.patch(`http://localhost:3004/users/${user.user.id}`, newDatacheckoutpaymant).then((data) => {
            actions.resetForm();
                                ...
                                <div>
                                    ...
                                    <div className='col-12 CHECKOUTbigestdiv1one1'>
                                        <div className="inputanderrormessagestyle col-12">
                                            <Field className='checkoutfirstdiv1input col-12 col-md-11' type="number" name="CardNumber" placeholder="Your Credit Card Number" />
                                            <Error>
                                                <ErrorMessage name="CardNumber" />
                                            </Error>
                                        </div>
                                        <div className="inputanderrormessagestyle col-12">
                                            <Field className='checkoutfirstdiv1input col-12 col-md-11' type="date" name="Expirationdate" placeholder="Expiration Date (MM / YY )" />
                                            <Error>
                                    ...
                                    <div className="inputanderrormessagestyle col-12">
                                        <Field className='checkoutfirstdiv1input col-12 col-md-11' type="number" name="SecurityCode" placeholder="Security Code In Card (CVV)" />
                                        <Error>
                                    ...
                                    <div className='col-12 CHECKOUTbigestdiv1one1'>
                                        <div className="inputanderrormessagestyle col-12">
                                            <Field className='checkoutfirstdiv1input col-12 col-md-11' type="text" name="cardholdername" placeholder="Cardholder Name" />
                                            <Error>
