...
export default function SingleProduct() {
  ...
  return (
    <div className="bigestsinglepagge col-12">
      <div
        className="bigestdiv col-12 wow animate__animated animate__fadeInDown animate__slow"
        data-wow-delay="0.2s"
      >
        ...
        <div className="secandbigestdiv col-10 col-md-5">
          ...
          <div className="twobuttonadd col-12">
            {isInCart ? (
              ...
              <button
                onClick={addToCart}
                className="addtoocartbtnnnSingleProduct"
              >
                <FaCartPlus />
              </button>
            )}
          ...
          <h3 className="h33bigestdiv">
            Brand : <span className="h333bigestdiv">{product.brand}</span>
          </h3>
          <h3 className="h33bigestdiv">
            Categories :{" "}
            <span className="h333bigestdiv">{product.category}</span>
          </h3>
        </div>
      </div>

      <div
        className="col-11 sllliderstyle wow animate__animated animate__fadeInLeft animate__slow"
        data-wow-delay="0.2s"
      >
        <ProductsSection
      ...
      <div
        className="SUBSCRIBEdiv1 wow animate__animated animate__fadeInRight animate__slow"
        data-wow-delay="0.2s"
      >
        <div className="SUBSCRIBEdiv col-12">
          <h1 className="SUBSCRIBEh1 col-11 col-lg-4">
            Sign Up For Newsletter & Get 20% Off
          </h1>
          <div className="SUBSCRIBEform col-11 col-lg-5">
            <SUBSCRIBE />
          </div>
        </div>
      </div>
