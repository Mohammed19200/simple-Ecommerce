  ...
  return (
    ...
    <div className="bigFavoriteitemdiv col-12">
      ...
      <div className=" Favoriteitemdiv11 col-10 col-md-5">
        ...
        <img className="imgfavorite col-12 col-md-5" src={product.thumbnail} alt="" />

        <div className="Favoriteitemdiv1 col-12 col-md-6">
          <h1 className="h1Favoriteitemdiv1"><Link className="text-decoration-none colorlinksfavorite" to={`/product/${product.id}`}>{product.title}</Link></h1>
      ...
      <div className="Favoriteitemdiv2 col-10 col-md-5">
        ...
        {isInCart ? null : (
          <div className=""><AddToCartBtn product={product} /></div>
        )}
      </div>
