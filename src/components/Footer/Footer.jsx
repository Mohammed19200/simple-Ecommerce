    ...
    >
      <div className="bigdivv11 col-12">
        <div className="footerbigdivstyle col-5 col-md-5 col-lg-3">
          ...
          <Link id="linkkstylee" className="text-decoration-none" to="/">
            Home
          </Link>
          <Link id="linkkstylee" className="text-decoration-none" to="/shop">
            Shop
          </Link>
          <Link id="linkkstylee" className="text-decoration-none" to="/cart">
            Cart
          </Link>
          <Link
            id="linkkstylee"
          ...
          <Link id="linkkstylee" className="text-decoration-none" to="/order">
            Order
          </Link>
        </div>
        ...
        <div className="footerbigdivstyle col-5 col-md-5 col-lg-3">
          ...
          <Link id="linkkstylee" className="text-decoration-none" to="/faq">
            About Us
          </Link>
          <Link
            id="linkkstylee"
        ...
        <div className="bigdivv2222 col-12">
          Copyright © Trade Shop All Right Reserved.
        </div>
      </div>
    </div>
  );
