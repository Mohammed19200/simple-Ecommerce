...
export default function TestimonialSlider() {
  return (
    <div className="largestdivlargestdiv col-12">
      <div className="largestdiv col-12">
        <h1 className="col-12 h1largestdiv">What Clients Say</h1>
        <figure className="snip1157 col-10 col-md-5 col-lg-3">
          <blockquote>
        ...
        <figure className="snip1157 hover col-10 col-md-5 col-lg-3">
          <blockquote>
